...
El archivo `vercel.json` programa un Cron Job una vez al dia, a las 03:00 de Ecuador, para llamar:
...
Cada foto pendiente se intenta hasta 5 veces. Si una función queda en `processing` por timeout, el siguiente cron diario la retoma cuando vuelva a ejecutarse.
